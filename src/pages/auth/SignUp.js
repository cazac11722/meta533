            ...
            <div className="flex flex-col items-center justify-center px-6 pt-8 mx-auto h-screen pt:mt-0 dark:bg-gray-900">
                ...
                <div className="w-full max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <form className="mt-8 space-y-6" action="#">
                        ...
                        <div>
                            <label htmlFor="passwordChk" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">비밀번호 확인</label>
                            <input type="passwordChk" name="passwordChk" id="passwordChk" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="" />
                        </div>
                        <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm">
                                <label htmlFor="remember" className="font-medium text-gray-900 dark:text-white">
                                    <Link to="" className="text-primary-700 hover:underline dark:text-primary-500">이용약관에</Link> 동의하기</label>
                            </div>
                        </div>
                        <button type="submit" className="w-full px-5 py-3 text-base  font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">회원가입</button>
                        <div className="text-sm font-medium text-gray-500 dark:text-gray-400">
                            이미 계정이 있으신가요?
                            <Link to="/meta533/login/" className="text-primary-700 hover:underline dark:text-primary-500">로그인 하기</Link>
                        </div>
                    </form> 
                </div>
            </div>
