                        ...
                        <div className="overflow-hidden shadow sm:rounded-lg">
                            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                                <thead className="bg-gray-50 dark:bg-gray-700">
                                    {
                                        data.thead.map((e, index) => (
                                            <tr key={index}>
                                                {
                                                    e.data.map((v, index) => (
                                                        <th scope="col" rowSpan={v.rowspan || 1} colSpan={v.colspan || 1} className={`p-4 text-xs font-medium tracking-wider text-${v.textAlign} text-gray-500 uppercase dark:text-white`}>
                                                            {v.title}
                                                        </th>
                                                    ))
                                                }
