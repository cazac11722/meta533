    ...
    return (
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm xl:col-span-3 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <div className="flex items-center mb-4 sm:mb-0">
                ...
                <div className="ml-4">
                    <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-white rounded-lg bg-primary-700 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-primary-800">
                        오늘
                    </a>
                    <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-white rounded-lg bg-primary-700 dark:bg-gray-600 dark:hover:bg-sky-700 dark:focus:ring-primary-800">
                        어제
                    </a>
                    <a href="#" class="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-white rounded-lg bg-primary-700 dark:bg-gray-600 dark:hover:bg-sky-700 dark:focus:ring-primary-800">
                        1주
